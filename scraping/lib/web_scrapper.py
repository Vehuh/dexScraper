...
class DexScraper ():
    def __init__(self):
        ...
        self._network_ids_for_gecko_terminal = ['eth', 'bsc', 'polygon_pos', 'avax', 'movr', 'cro', 'one', 'boba', 
                                                'ftm', 'bch', 'aurora', 'metis', 'arbitrum', 'fuse', 'okexchain', 
                                                'kcc', 'iotx', 'celo', 'xdai', 'heco', 'glmr', 'optimism', 'nrg', 
                                                'wan', 'ronin', 'kai', 'mtr', 'velas', 'sdn', 'tlos', 'sys', 'oasis', 
                                                'astr', 'ela', 'milkada', 'dfk', 'evmos', 'solana', 'cfx', 'bttc', 
                                                'sxn', 'xdc', 'klaytn', 'kava', 'bitgert', 'tombchain', 'dogechain', 
                                                'findora', 'thundercore', 'arbitrum_nova', 'canto', 'ethereum_classic', 
                                                'step-network', 'ethw', 'godwoken', 'songbird', 'redlight_chain', 
                                                'tomochain', 'fx', 'platon_network', 'exosama', 'oasys', 'bitkub_chain', 
                                                'wemix', 'flare', 'onus', 'aptos', 'core', 'goerli-testnet', 'filecoin', 
                                                'lung-chain', 'zksync', 'poochain', 'loop-network', 'multivac', 'polygon-zkevm', 
                                                'eos-evm', 'apex', 'callisto', 'ultron', 'sui-network', 'pulsechain', 
                                                'trustless-computer', 'enuls', 'tenet', 'rollux', 'starknet-alpha', 'mantle', 
                                                'neon-evm', 'linea', 'base', 'bitrock', 'opbnb', 'maxxchain', 'sei-network', 
                                                'shibarium', 'manta-pacific', 'sepolia-testnet', 'hedera-hashgraph', 'shimmerevm']
    ...
    def get_ohlcv (self, network = "solana", pool_address = "", timeframe = "minute", aggregate = "1", limit = "1", currency = "usd"):
